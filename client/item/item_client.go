...
type ClientService interface {
	CreateItem(params *CreateItemParams, opts ...ClientOption) (*CreateItemCreated, error)
...
*/
func (a *Client) CreateItem(params *CreateItemParams, opts ...ClientOption) (*CreateItemCreated, error) {
	...
	success, ok := result.(*CreateItemCreated)
	if ok {
		return success, nil
	}
